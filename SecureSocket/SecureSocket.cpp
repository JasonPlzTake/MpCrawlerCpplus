// SecureSocket.cpp : This file contains the 'main' function. Program execution begins and ends there.
...
#include "EventWrapper.h" // Client include
...
#include "sslclient.h"  // Client include
#include "ActiveSock.h" // Client include
